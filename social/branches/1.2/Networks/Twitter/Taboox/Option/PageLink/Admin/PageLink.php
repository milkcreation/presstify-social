<?php
namespace tiFy\Plugins\Social\Networks\Twitter\Taboox\Option\PageLink\Admin;
...
{	
	...
	{
		$defaults 	= array( 'uri' => '' ); 
		$value 		= isset( \tiFy\Plugins\Social\Social::$Options['tweet'] ) ? wp_parse_args( \tiFy\Plugins\Social\Social::$Options['tweet'], $defaults ) : $defaults;
	?>
